...
@section('content')
    <div class="row">
        <div class="col-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('admin.subcategory.store') }}`)" class="btn btn-sm btn-primary"><i
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Tambah Data SubKategori') {
            $(modal).modal('show');
        ...
        // fungsi edit data
        function editForm(url, title = 'Edit Data SubKategori') {
